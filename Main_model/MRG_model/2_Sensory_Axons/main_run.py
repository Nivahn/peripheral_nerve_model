...
fiber_diam = [5.7]
v_init = -80.0
t_stop_ms = 1100.0                         # после стимуляции ещё хвост
t_start_ms=100.0
phase_us=40.0
gap_us=5.0
dt=0.005
...
for diameter in tqdm(fiber_diam, desc="Diameter"):
    axon = MRGaxon(
        fiber_diameter=diameter,
    ...
    for amp_nA in tqdm(amplitudes, desc="Amplitudes"):
        ...
        # --------------------------
        h5_path = f"./../../../Data/sensory_axon/MRG_50_1000Hz_diam_{diameter}_amp_{amp_nA}.h5"
