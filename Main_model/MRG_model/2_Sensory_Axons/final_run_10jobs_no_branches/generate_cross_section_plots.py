...
SCENARIO_NAME = "no_branch_reference"
    ...
    for diameter_um in DIAMETERS_UM:
        ...
        for edge_dist_um in EDGE_DISTANCES_UM:
            for mode_name in MODES:
                ...
                png_path = out_dir / (
                    f"two_axons_no_branch_fd{diameter_um}_ed{edge_dist_um}_{mode_name}_cross.png"
                )
        ...
        fig.suptitle(f"No-branch cross-section boundary layout | fiber diameter {diameter_um} um", fontsize=14)
        fig.tight_layout(rect=(0, 0, 1, 0.98))
        overview_path = out_dir / f"overview_no_branch_fd{diameter_um}_all_modes_all_distances_cross.png"
        ...
        fig.suptitle(f"No-branch boundary layout | fiber diameter {diameter_um} um", fontsize=14)
        fig.tight_layout(rect=(0, 0, 1, 0.97))
        boundary_overview_path = out_dir / f"overview_no_branch_fd{diameter_um}_boundary_on_off_by_distance_cross.png"
